window.Range = (function(doc){
    ...
    function Range(str,fn){
        ...
        this.knobOffset = this.knobWidth / 2;
        ...
        bind : function(){
            ...
            function down(ev){
                ...
                if(target.getAttribute('data-drag') !== null){
                    ...
                    var _left = e.pageX - t.dom.getBoundingClientRect().left,d1 = Math.abs(_left - t.range1Dom.getAttribute('data-nums')),d2 = Math.abs(_left - t.range2Dom.getAttribute('data-nums'));
